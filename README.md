...
## Model weights
The pretrained weights of MedMPT can be accessed upon request via [Huggingface](https://huggingface.co/TaoMedAI/RareSeek-R1) for non-commercial research and academic use.
